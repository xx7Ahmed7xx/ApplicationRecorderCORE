...
namespace RecordingCORE
{
    ...
    public class Recorder
    {
        ...
        public static void StartFullScreenSimpleRecording()
        {
            keepRecording = true;
            ...
            ffmpegProc.StartInfo.Arguments
                =
                $".\\ffmpeg -init_hw_device d3d11va -filter_complex ddagrab=0 -c:v h264_nvenc -cq:v 20 1.mp4";
            ffmpegProc.Start();
            while (keepRecording)
            {
                Thread.Sleep(50); 
            ...
            //SetForegroundWindow(ffmpegProc.MainWindowHandle);
            //SendKeys.SendWait("q");
        }

        /// <summary>
        /// Stops the WindowScreen recording process. (You can use <see cref="StopFullScreenRecording()"/> Method aswell.)
        /// </summary>
        ...
        /// MemoryStream at the Starting process. (You can use <see cref="StopFullScreenSimpleRecording()"/> Method aswell.)
        /// </summary>
